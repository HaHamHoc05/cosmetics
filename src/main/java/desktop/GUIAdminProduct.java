...
public class GUIAdminProduct extends JFrame implements Subscriber {
    ...
    private void setupUI() {
        ...
        addToGrid(new JLabel("Giá (VNĐ):"), txtPrice, row++, gbc);
        ...
        btnAdd.addActionListener(e -> {
            try {
                ...
                // Chuyển String -> BigDecimal cho đúng Core
                ...
                JOptionPane.showMessageDialog(this, "Dữ liệu nhập không hợp lệ (Giá/Số lượng)!");
            }
        });
    }

    private void addToGrid(JLabel lbl, Component comp, int row, GridBagConstraints gbc) {
        gbc.gridx = 0; gbc.gridy = row; add(lbl, gbc);
